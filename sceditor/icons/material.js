...
(function (document, sceditor) {
	...
	sceditor.icons.material = function () {
        ...
        console.warn("Create Icon Material");
				if (command in icons) {
          ...
          var imgpath = "img/icons-svg/";
          switch (command) {
            case "load":
              img.setAttribute("src", imgpath+"fa-folder-open-black.svg");
            break;
            case "save":
              img.setAttribute("src", imgpath+"fa-file-save-black.svg");
            break;
						case "header":
              img.setAttribute("src", imgpath+"i4m-header-black.svg");
            break;
            default:
             img.setAttribute("src", imgpath+"info-black.svg");
          }
          nodes[command] = img;
        }
